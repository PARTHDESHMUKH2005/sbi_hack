      ...
      >
        ...
        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.99 }}
            type="submit"
            className="w-full bg-[#00C896] text-[#0A0F1E] font-semibold py-3 rounded-xl hover:bg-[#00b086] transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#00C896]/20"
          >
            Sign In
            <ArrowRight size={18} />
          </motion.button>
